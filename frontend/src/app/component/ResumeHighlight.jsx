    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto flex flex-col min-h-[70vh] items-center px-6 md:px-8 mt-20">
        ...
        <div className="relative flex justify-center items-center mt-10">
          ...
          {/* ===== Interactive Points ===== */}
          <div className="absolute hidden md:flex items-center gap-1 right-[353px] top-[14%]">
            <motion.p
              onHoverStart={handlePointHoverStart}
              onHoverEnd={handlePointHoverEnd}
              whileHover={{ scale: 1.25, color: "#4da3ff" }}
              transition={{ type: "spring", stiffness: 250, damping: 10 }}
              className="text-m text-gray-100 josefin-sans whitespace-nowrap cursor-none select-none"
            >
              Creative Direction
            </motion.p>
            <svg
          ...
          <div className="absolute hidden md:flex items-center gap-2 left-[320px] top-[14%]">
            <svg
              width="280"
              height="140"
              viewBox="0 0 280 140"
            ...
            <motion.p
              ...
              whileHover={{ scale: 1.25, color: "#4da3ff" }}
              transition={{ type: "spring", stiffness: 250, damping: 10 }}
              className="text-base font-medium text-gray-100 josefin-sans whitespace-nowrap text-right -ml-2 cursor-none select-none"
            >
              UI/UX Design
            </motion.p>
          </div>
          ...
          <div className="absolute hidden md:flex items-center gap-3 right-[320px] bottom-[22%]">
            <motion.p
              ...
              whileHover={{ scale: 1.25, color: "#4da3ff" }}
              transition={{ type: "spring", stiffness: 250, damping: 10 }}
              className="text-m josefin-sans text-gray-100 whitespace-nowrap cursor-none select-none"
            >
              Development
            </motion.p>
            <svg
