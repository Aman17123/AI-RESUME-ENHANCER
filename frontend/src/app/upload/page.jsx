      ...
      >
        ...
        ">
          ...
          >
            ...
            {!loading && fileName && <p className="text-sm text-gray-800 break-all px-4 text-center">Selected: {fileName}</p>}

            <p className="text-xs font-bold text-gray-600 mt-1">**PDF or DOCX only**</p>
          </motion.div>
        </div>
      </div>
