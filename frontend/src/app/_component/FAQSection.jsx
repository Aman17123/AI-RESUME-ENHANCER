...
const faqs = [
  {
    ...
    a: "An Applicant Tracking System (ATS) is software recruiters use to scan resumes before a human sees them. It filters applications by keywords and formatting, so many great resumes never get seen. CVForge tailors your resume to match the job description so it clears the ATS scan and reaches a real person.",
  },
  {
  ...
  {
    q: "Do I need an account to use CVForge?",
