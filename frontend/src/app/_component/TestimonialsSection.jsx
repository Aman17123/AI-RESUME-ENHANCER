...
const testimonials = [
  {
    ...
    color: "bg-[#021F81]",
    quote:
      "My resume kept getting rejected before the interview stage. CVForge found the missing keywords, I added them, and I got 3 callbacks within two weeks.",
  },
  {
    name: "Rahul Verma",
    ...
    <section className="relative josefin-sans w-full py-24 px-6 overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-600 mt-4 text-base sm:text-lg">
          Real results from people who beat the ATS with CVForge.
        </p>
      </motion.div>
