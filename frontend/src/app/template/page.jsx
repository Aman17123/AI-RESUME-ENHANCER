...
const cards = [
  { img: "https://i.pinimg.com/736x/06/68/5f/06685f48d58f7d16933416ba2a918169.jpg" },
  { img: "https://i.pinimg.com/736x/06/68/5f/06685f48d58f7d16933416ba2a918169.jpg" },
  { img: "https://i.pinimg.com/736x/06/68/5f/06685f48d58f7d16933416ba2a918169.jpg" },
  { img: "https://i.pinimg.com/736x/06/68/5f/06685f48d58f7d16933416ba2a918169.jpg" },
];
...
function HeroSection({ onSelectClick }) {
  return (
    <section className="relative flex flex-col josefin-sans items-center justify-center min-h-screen text-white px-6 text-center overflow-hidden">
      ...
      >
        Stop Applying. Start <span className="underline">Getting</span> <br /> Hired.
      </motion.h1>
      ...
      <motion.p
        ...
        className="mt-4 max-w-xl text-sm md:text-base text-gray-300"
      >
  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center px-4 md:px-16 py-20 relative overflow-hidden text-white">
      ...
      <div className="flex flex-wrap justify-center gap-10 max-w-[1400px] mx-auto">
        {cards.map((card, i) => (
          <ResumeCard key={i} img={card.img} index={i} />
        ))}
      </div>
